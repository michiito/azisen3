...
import UIKit
import MapKit
class ariakeViewController: UIViewController {
    
    let width = UIScreen.main.bounds.width
    let height = UIScreen.main.bounds.height
    
    let scrollView = UIScrollView()
    let image = UIImage(named: "s.ariake")
    ...
    let tellNumber = NSURL(string: "tel:0969-52-0055")!
    ...
    override func viewDidLoad() {
        ...
        text.text = "味千拉麺有明店が、リニューアルオープン！\n新しく綺麗になった店舗で、またお客様をお出迎え致します。\nお近くへ来られた方は是非お立ち寄りください！"
        ...
        conLabel2.text = "熊本県天草市有明町小島子491-1"
