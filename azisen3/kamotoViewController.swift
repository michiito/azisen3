...
import UIKit
import MapKit
class kamotoViewController: UIViewController {
    
    let width = UIScreen.main.bounds.width
    let height = UIScreen.main.bounds.height
    let scrollView = UIScrollView()
    let image = UIImage(named: "s.kamoto")
    ...
    let tellNumber = NSURL(string: "tel:0968-46-3469")!
    
    let latitude = "32.985269"
    let longitude = "130.465179"
    ...
    override func viewDidLoad() {
        ...
        text.frame = CGRect(x: 5, y: label2.layer.position.y + 30, width: width - 10, height: 160)
        text.font = UIFont.systemFont(ofSize: 10)
        text.text = "味千ラーメン鹿本店の近くには多くの遊べるスポットがあります。\n\n石で作られた風車のある公園ではお花見を、\n夏には涼しい矢谷渓谷、秋にはあんずの丘で紅葉を楽しめる場所です。\n\nお弁当のお供にはテイクアウトの味千商品もご用意できます。\n行き慣れた味千ラーメンの店舗とのまた違った鹿本店を楽しんでください。"
        ...
        conLabel2.text = "熊本県山鹿市鹿本町津袋40-1"
        ...
        let center = CLLocationCoordinate2DMake(32.985269, 130.465179)
