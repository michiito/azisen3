...
import UIKit
import MapKit
class araoViewController: UIViewController {
    
    let width = UIScreen.main.bounds.width
    let height = UIScreen.main.bounds.height
    let scrollView = UIScrollView()
    let image = UIImage(named: "s.arao")
    ...
    let tellNumber = NSURL(string: "tel:0968-82-8088")!
    ...
    override func viewDidLoad() {
        ...
        text.text = "荒尾市のグリーンランド前に味千拉麺荒尾グリーンランド前店がオープンしま\nした。\n店舗向かいには、グリーンランド遊園地が見えてます。\n\nご家族でもOKの4〜6人席小上がり席や、カウンター 席・2〜4人テーブル席\n店内46席ございます。豊富なメニューを元気なスタッフがお待ちしていま\nす。\n\n是非お近くの皆さんご来店ください。\n\n店舗詳細情報"
