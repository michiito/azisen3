...
class higasibypasViewController: UIViewController {
    
    let width = UIScreen.main.bounds.width
    let height = UIScreen.main.bounds.height
    
    let scrollView = UIScrollView()
    let image = UIImage(named: "s.eastOfBypas")
    ...
    let tellNumber = NSURL(string: "tel:096-380-8937")!
    
    let latitude = "32.823144"
    let longitude = "130.761025"
    ...
    override func viewDidLoad() {
        ...
        conLabel2.text = "熊本市東区下南部3丁目13番57号"
        ...
        let center = CLLocationCoordinate2DMake(32.823144, 130.761025)
