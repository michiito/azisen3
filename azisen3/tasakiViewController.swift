...
class tasakiViewController: UIViewController {
    
    let width = UIScreen.main.bounds.width
    let height = UIScreen.main.bounds.height
    
    let scrollView = UIScrollView()
    let image = UIImage(named: "s.tasaki")
    ...
    let tellNumber = NSURL(string: "tel:096-247-6633")!
    
    let latitude = "32.783938"
    let longitude = "130.678009"
    ...
    override func viewDidLoad() {
        ...
        let center = CLLocationCoordinate2DMake(32.783938, 130.678009)
