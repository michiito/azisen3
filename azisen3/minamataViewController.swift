...
import UIKit
import MapKit
class minamataViewController: UIViewController {
    
    let width = UIScreen.main.bounds.width
    let height = UIScreen.main.bounds.height
    
    let scrollView = UIScrollView()
    let image = UIImage(named: "s.minamata")
    ...
    let photo4 = UIImage(named: "s.tomiai")
    let photo5 = UIImage(named: "s.tasaki")
    let photo6 = UIImage(named: "s.arao")
    let photo7 = UIImage(named: "s.kamoto")
    let photo8 = UIImage(named: "s.ariake")
    ...
    let tellNumber = NSURL(string: "tel:0966-83-8250")!
    
    
    let latitude = "32.485496"
    let longitude = "130.284258"
    ...
    override func viewDidLoad() {
        ...
        text.frame = CGRect(x: 5, y: label2.layer.position.y + 30, width: width - 10, height: 30)
        text.font = UIFont.systemFont(ofSize: 10)
        text.text = "2020年1月18日（土）オープン"
        ...
        conLabel2.text = "熊本県水俣市港町2丁目2番地5号"
        ...
        conLabel12.text = "※その他、機材メンテナンスのための臨時休業の場合有"
        ...
        let center = CLLocationCoordinate2DMake(32.485496, 130.284258)
        ...
        shopButton4.setTitle("富合店", for: .normal)
        ...
        shopButton5.setTitle("イオンタウン田崎店", for: .normal)
        ...
        shopButton6.setTitle("荒尾グリーンランド前店", for: .normal)
        ...
        shopButton7.setTitle("鹿本店", for: .normal)
        ...
        shopButton8.setTitle("有明店", for: .normal)
