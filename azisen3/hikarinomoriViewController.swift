...
class hikarinomoriViewController: UIViewController {
    
    let width = UIScreen.main.bounds.width
    let height = UIScreen.main.bounds.height
    
    let scrollView = UIScrollView()
    let image = UIImage(named: "s.hikarinomori")
    ...
    let tellNumber = NSURL(string: "tel:096-288-1058")!
    
    let latitude = "32.858199"
    let longitude = "130.782479"
    ...
    override func viewDidLoad() {
        ...
        conLabel2.text = "熊本県菊池郡菊陽町光の森2-23-5"
        ...
        let center = CLLocationCoordinate2DMake(32.858199, 130.782479)
